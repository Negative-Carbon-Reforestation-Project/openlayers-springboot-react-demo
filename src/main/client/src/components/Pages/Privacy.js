                ...
                <section className="privacy-content" tabIndex={0} aria-label="Privacy Policy" role="document">
                    ...
                    <article className="privacy-article">
                        ...
                        <ul className="privacy-definitions">
                            ...
                            <li>
                                <p><strong>Website</strong> refers to Negative Carbon Reforestation Project, accessible from <a href="http://www.ncrp.org" rel="external nofollow noopener" target="_blank">http://www.ncrp.org</a></p>
                            </li>
                            <li>
